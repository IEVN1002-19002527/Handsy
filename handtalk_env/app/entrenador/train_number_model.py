"""
Script para entrenar el modelo de números (0-5) con imágenes capturadas de la cámara.
"""
import os
import cv2
import numpy as np
...
# Configuración
DATA_DIR = "collected_number_data"  # Directorio para datos de números
MODEL_DIR = "model"
MODEL_PATH = os.path.join(MODEL_DIR, "number_model_camera.h5")
...
def main():
    ...
    base_model_path = os.path.join(MODEL_DIR, "number_model.h5")
